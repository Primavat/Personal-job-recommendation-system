    ...
    <html lang="en">
      <body className="min-h-screen flex flex-col bg-white dark:bg-black">
        <Providers>
          ...
          <footer className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-black mt-auto">
            <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
              <span className="text-sm text-gray-400 dark:text-gray-500">
                © {new Date().getFullYear()} JobRec. All rights reserved.
              </span>
              <span className="text-sm text-gray-400 dark:text-gray-500">
                Built by <span className="text-gray-600 dark:text-gray-400 font-medium">Primavat</span>
              </span>
            </div>
          </footer>
        </Providers>
